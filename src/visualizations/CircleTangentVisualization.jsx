...
export default function CircleTangentVisualization() {
  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      if (state.showDB) crossArrow.setLength(1.55 * (0.88 + 0.12 * (0.5 + 0.5 * Math.sin(state.planeTime * 2.4))), 0.3, 0.18);
      if (state.showNetB) netBArrow.setLength(1.45 * (0.9 + 0.1 * (0.5 + 0.5 * Math.sin(state.planeTime * 1.8))), 0.3, 0.18);
