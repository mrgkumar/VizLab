...
import { Atom, Beaker, CircuitBoard, Home, Sigma, Zap } from "lucide-react";
...
const SolenoidVisualization = lazy(() => import("./visualizations/SolenoidVisualization"));
...
const visualizations = [
  ...
  {
    id: "solenoid",
    title: "Solenoid Field Lab",
    summary: "See how many current loops build the magnetic field of a finite solenoid.",
    icon: Zap,
    component: SolenoidVisualization,
    tag: "Physics",
  },
];
